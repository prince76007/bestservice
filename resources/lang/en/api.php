...
return array (
	...
	'push' => [
		'request_accepted' => 'Your request has been accepted successfully by provider.',
		'arrived' => 'Provider Arrived at your Location',
		...
		'provider_not_available' => 'Sorry for inconvience time, Our partner are busy. Please try after some time',
		'user_cancelled' => 'User Cancelled the Ride',
		'provider_cancelled' => 'Provider Cancelled the Ride',
		'schedule_start' => 'Your Service has been successfully started by provider.',
		'ride_scheduled' => 'Your Service has been Scheduled',
        'dropped' => 'Your Service has been completed by provider.'
	],
);