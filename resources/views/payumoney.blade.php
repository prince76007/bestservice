  ...
  <body onload="submitPayuForm()">
    Processing.....
        <form action="<?php echo $action; ?>" method="post" name="payuForm"><br />
            ...
            <input type="hidden" name="amount" value="10" /><br />
            <input type="hidden" name="firstname" id="firstname" value="salman" /><br />
            <input type="hidden" name="email" id="email" value="ksbmsalman@gmail.com" /><br />
