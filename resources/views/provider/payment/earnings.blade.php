                ...
                <div class="earning-element row no-margin">
                 ...
                 <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                        <div class="earning-box">
                            ...
                            <p class="dashboard-txt">@lang('main.service')s COMPLETED TODAY</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                        <div class="earning-box">
                            ...
                            <p class="dashboard-txt">DAILY @lang('main.service') TARGET </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                        <div class="earning-box">
                            ...
                            <p class="dashboard-txt">FULLY COMPLETED @lang('main.service')s</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                        <div class="earning-box">
                            ...
                            <p class="dashboard-txt">@lang('main.provider') CANCELLATIONS</p>
                        </div>
                    </div>
                                ...
                                <div class="row no-margin">
                                    <div class="pull-left trip-left">
                                        <h3 data-toggle="collapse" data-target="#demo1" class="accordion-toggle collapsed acc-tit">
                                            <span class="arrow-icon fa fa-chevron-right"></span>@lang('main.service') Earnings
                                        </h3>
                                    </div>
                                </div>
                                    ...
                                    <form class="form-inline status-form">
                                        <div class="form-group">
                                            ...
                                            <select type="password" class="form-control mx-sm-3">
                                                <option>All @lang('main.service')s</option>
