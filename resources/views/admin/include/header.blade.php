	...
	<nav class="navbar navbar-light">
		<div class="navbar-left">
			<a class="navbar-brand" href="{{url('admin/dashboard')}}">
               ...
               <img src="{{Setting::get('site_logo')}}" style="width:41px">
				<!--div class="logo" style="background: url({{Setting::get('site_logo')}}) no-repeat;background-size: contain;filter: invert(100%);"></div-->
			</a>
