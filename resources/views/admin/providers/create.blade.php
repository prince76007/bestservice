...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;">Add @lang('main.provider')</h5>

            <form class="form-horizontal" action="{{route('admin.provider.store')}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
            	<?php $randomId=substr(str_shuffle("0123456789"), 0, 6);?>
            	 <input type="hidden" name="uniq_no" value="{{ getProviderId() }}">
				...
				<div class="form-group row">
					<label for="mobile" class="col-xs-12 col-form-label">URL</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ old('provider_url') }}" name="provider_url"  id="provider url" placeholder="provider_url">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<button type="submit" class="btn btn-primary">Add @lang('main.provider')</button>
