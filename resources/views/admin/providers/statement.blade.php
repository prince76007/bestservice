            	...
            	<div class="row">
	            	...
	            	<div class="col-lg-4 col-md-6 col-xs-12">
						<div class="box box-block bg-white tile tile-1 mb-2">
							...
							<div class="t-content">
								<h6 class="text-uppercase mb-1">Total No. of @lang('main.service')</h6>
								<h1 class="mb-1">{{$rides->count()}}</h1>
								<span class="text-muted font-90">% down from cancelled @lang('main.service')</span>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-6 col-xs-12">
						<div class="box box-block bg-white tile tile-1 mb-2">
							...
							<div class="t-content">
								...
								<i class="fa fa-caret-up text-success mr-0-5"></i><span>from {{$rides->count()}} @lang('main.service')</span>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-6 col-xs-12">
						<div class="box box-block bg-white tile tile-1 mb-2">
							...
							<div class="t-content">
								<h6 class="text-uppercase mb-1">Cancelled @lang('main.service')</h6>
								<h1 class="mb-1">{{$cancel_rides}}</h1>
								<i class="fa fa-caret-down text-danger mr-0-5"></i><span>for @if($cancel_rides == 0) 0.00 @else {{round($cancel_rides/$rides->count(),2)}}% @endif @lang('main.service')</span>
							</div>
						</div>
					</div>
										...
										@if(count($rides) != 0)
								            <table class="table table-striped table-bordered dataTable" id="table-2">
								                <thead>
								                   <tr>
														<td>Booking ID</td>
														<td>@lang('main.service') Location</td>
														<td>@lang('main.service') Details</td>
														<td>Commission</td>
														<td>Dated on</td>
														<td>Status</td>
														<td>Earned</td>
