...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;">Update @lang('main.provider')</h5>
            ...
            <form class="form-horizontal" action="{{route('admin.provider.update', $provider->id )}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					<label for="mobile" class="col-xs-2 col-form-label">URL</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ $provider->provider_url }}" name="provider_url"  id="provider_url" placeholder="provider url">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<button type="submit" class="btn btn-primary">Update @lang('main.provider')</button>
