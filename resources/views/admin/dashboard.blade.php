    ...
    <div class="row row-md">
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">Total No. of @lang('main.service')s</h6>
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					...
					<i class="fa fa-caret-up text-success mr-0-5"></i><span>from {{$rides->count()}} @lang('main.service')s</span>
				</div>
			</div>
		</div>
		<div class="col-lg-3 col-md-6 col-xs-12">
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">Cancelled @lang('main.service')s</h6>
					<h1 class="mb-1">{{$cancel_rides}}</h1>
					<i class="fa fa-caret-down text-danger mr-0-5"></i><span>for @if($cancel_rides == 0) 0.00 @else {{round($cancel_rides/$rides->count(),2)}}% @endif @lang('main.service')s</span>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row row-md mb-2">
		<div class="col-md-12">
				<div class="box bg-white">
					<div class="box-block clearfix">
						<h5 class="float-xs-left">Recent @lang('main.service')s</h5>
							...
							<tr>
								...
								<td>
									@if($ride->status != "CANCELLED")
										<a class="text-primary" href="{{route('admin.request.details',$ride->id)}}"><span class="underline">View @lang('main.service') Details</span></a>
									@else
		...
		<div class="box box-block bg-white">
				<div class="clearfix mb-1">
					<h5 class="float-xs-left">@lang('main.service')s statistics</h5>
					<div class="float-xs-right">
						<button class="btn btn-link btn-sm text-muted" type="button"><i class="ti-close"></i></button>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-4 demo-progress">
							<h5 class="mb-2">@lang('main.provider')s Rating</h5>
